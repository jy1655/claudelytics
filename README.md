...
[![CI](https://github.com/jy1655/claudelytics/actions/workflows/ci.yml/badge.svg)](https://github.com/jy1655/claudelytics/actions/workflows/ci.yml)
...
This repository is an independently maintained fork of [nwiizo/claudelytics](https://github.com/nwiizo/claudelytics), released under the MIT License.

- Upstream base: `nwiizo/claudelytics`
- Fork maintainer repo: `jy1655/claudelytics`
- Focus of this fork:
  - Compatibility updates for recent Claude Code transcript/session formats
  - Pricing table refresh aligned with current Claude model pricing
  - Parser and CLI robustness improvements for production use
...
- **💾 Offline Pricing Cache**: 7-day local cache for built-in model pricing data (no internet required)

### Interactive & Real-time
- **🎯 Interactive Mode**: peco-style fuzzy searchable session selector
- **🎨 Enhanced TUI**: Full-featured terminal interface with 8 tabs including conversations and resume
- **🚀 Advanced TUI**: Launch advanced mode via `advanced-tui` command or `--advanced-tui` flag
...
curl -fsSL https://raw.githubusercontent.com/jy1655/claudelytics/main/install.sh | bash -s -- --dir ~/.local/bin

# Install specific version
curl -fsSL https://raw.githubusercontent.com/jy1655/claudelytics/main/install.sh | bash -s -- --version v0.5.2
...
claudelytics tui                    # Enhanced TUI (8 tabs)
claudelytics --tui                  # Alternative flag
claudelytics advanced-tui           # Advanced mode alias for TUI
...
claudelytics pricing-cache --update # Refresh cache from built-in pricing data
...
claudelytics --model-filter opus4.6     # Opus 4.6 models
claudelytics --model-filter sonnet-4.5  # Sonnet 4.5 models

# Filter by specific model
claudelytics --model-filter claude-opus-4-6
...
- **🔄 Resume Tab**: Resume session shortcuts and quick access workflows
- **❓ Help Tab**: Comprehensive help with keyboard shortcuts

**Navigation:**
- Use `1-8` keys or `Tab`/`Shift+Tab` to switch tabs
...
Advanced mode launch command for the same TUI interface, with workflows like:
...
Please read [CONTRIBUTING.md](CONTRIBUTING.md) for development workflow, code quality gates, and PR guidelines.

## 🔒 Security

Please read [SECURITY.md](SECURITY.md) for responsible vulnerability reporting.
...
- Originally built by the upstream project maintainers at [nwiizo/claudelytics](https://github.com/nwiizo/claudelytics)
- Maintained and extended in this fork for current Claude Code ecosystem changes
