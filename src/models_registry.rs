...
impl ModelsRegistry {
    ...
    fn register_default_models(&mut self) {
        ...
        self.register_model(ModelInfo {
            ...
            aliases: vec!["opus-4.6".to_string(), "opus4.6".to_string()],
        ...
        self.register_model(ModelInfo {
            ...
            aliases: vec!["sonnet-4.6".to_string(), "sonnet4.6".to_string()],
            family: "sonnet".to_string(),
            version: Some("4.6".to_string()),
            release_date: Some("2026-02-24".to_string()),
        });
        ...
        self.register_model(ModelInfo {
            ...
            aliases: vec!["sonnet-3.7".to_string(), "sonnet3.7".to_string()],
            family: "sonnet".to_string(),
            version: Some("3.7".to_string()),
            release_date: Some("2025-02-19".to_string()),
        });
