...
curl -fsSL https://github.com/jy1655/claudelytics/releases/download/v0.1.0/claudelytics-x86_64-apple-darwin.tar.gz | shasum -a 256
curl -fsSL https://github.com/jy1655/claudelytics/releases/download/v0.1.0/claudelytics-aarch64-apple-darwin.tar.gz | shasum -a 256
curl -fsSL https://github.com/jy1655/claudelytics/releases/download/v0.1.0/claudelytics-x86_64-unknown-linux-gnu.tar.gz | shasum -a 256
curl -fsSL https://github.com/jy1655/claudelytics/releases/download/v0.1.0/claudelytics-aarch64-unknown-linux-gnu.tar.gz | shasum -a 256
...
class Claudelytics < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/jy1655/claudelytics/releases/download/vX.Y.Z/claudelytics-aarch64-apple-darwin.tar.gz"
      sha256 "SHA256_HERE"  # <- Update this
    else
      url "https://github.com/jy1655/claudelytics/releases/download/vX.Y.Z/claudelytics-x86_64-apple-darwin.tar.gz"
      sha256 "SHA256_HERE"  # <- Update this
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm? && Hardware::CPU.arch == :arm64
      url "https://github.com/jy1655/claudelytics/releases/download/vX.Y.Z/claudelytics-aarch64-unknown-linux-gnu.tar.gz"
      sha256 "SHA256_HERE"  # <- Update this
    else
      url "https://github.com/jy1655/claudelytics/releases/download/vX.Y.Z/claudelytics-x86_64-unknown-linux-gnu.tar.gz"
      sha256 "SHA256_HERE"  # <- Update this
    end
  end
...
1. Direct them to [GitHub Issues](https://github.com/jy1655/claudelytics/issues)
