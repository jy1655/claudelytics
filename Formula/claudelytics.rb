class Claudelytics < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/jy1655/claudelytics/releases/download/v#{version}/claudelytics-aarch64-apple-darwin.tar.gz"
      sha256 "PLACEHOLDER_ARM64_SHA256"
    else
      url "https://github.com/jy1655/claudelytics/releases/download/v#{version}/claudelytics-x86_64-apple-darwin.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.arm? && Hardware::CPU.arch == :arm64
      url "https://github.com/jy1655/claudelytics/releases/download/v#{version}/claudelytics-aarch64-unknown-linux-gnu.tar.gz"
      sha256 "PLACEHOLDER_LINUX_ARM64_SHA256"
    else
      url "https://github.com/jy1655/claudelytics/releases/download/v#{version}/claudelytics-x86_64-unknown-linux-gnu.tar.gz"
  ...
  def caveats
    <<~EOS
      ...
      For more information, visit: https://github.com/jy1655/claudelytics
    EOS
  end
end